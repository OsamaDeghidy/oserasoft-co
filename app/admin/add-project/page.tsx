      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-nickel/80 mt-2">
            املأ النموذج أدناه لإضافة مشروع جديد إلى البورتفوليو
          </p>
        </motion.div>
        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={4}
              className="w-full px-4 py-3 bg-lisbon-brown/30 border-2 border-luxor-gold/30 rounded-xl focus:outline-none focus:border-luxor-gold focus:ring-4 focus:ring-luxor-gold/20 transition-all resize-none text-silver placeholder-gray-nickel/60"
          ...
          {submitStatus === 'success' && (
            ...
            >
              ✓ تم إضافة المشروع بنجاح! سيتم توجيهك إلى صفحة المشاريع...
            </motion.div>
          )}
